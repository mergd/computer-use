/**
 * utility-tools.js - Miscellaneous utility tools
 *
          ...
          try {
            ...
            if (coordinate) {
              ...
              if (window.__claudeElementMap && window.__claudeElementMap[elementRef]) {
                target = window.__claudeElementMap[elementRef].deref() || null;
...
// turn_answer_start schema
const turnAnswerStartSchema = { type: "object", properties: {}, required: [] };

// turn_answer_start tool (Me)
...
// Helper to launch shortcut in new window
