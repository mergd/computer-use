 ...
 */
type AgentIndicatorMessageType =
 ...
 */
interface AgentIndicatorMessage {
  type: AgentIndicatorMessageType;
}

/**
 * Response to background script messages
 */
interface AgentIndicatorResponse {
  success: boolean;
}

/**
 * Heartbeat response from background script
 */
...
(function (): void {
  (function (): void {
    ...
    `;
      ...
      const chatTooltip = container.querySelector(
      ...
      const closeTooltip = container.querySelector(
    ...
    function showStaticIndicator(): void {
      ...
      heartbeatIntervalId = setInterval(async () => {
        try {
          ...
          })) as HeartbeatResponse | undefined;
    ...
    chrome.runtime.onMessage.addListener(
      (
        message: AgentIndicatorMessage,
        _sender: chrome.runtime.MessageSender,
        sendResponse: (response: AgentIndicatorResponse) => void
      ): boolean | void => {
