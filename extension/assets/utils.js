/**
 * utils.js - Utility functions for MCP tools
 *
...
export const toAnthropicSchemas = async (tools, context) =>
...
export async function checkNavigationInterception(tabId, originalUrl, actionName) {
  ...
  if (isRestrictedUrl(tab.url)) {
    return { error: `Cannot interact with restricted URL: ${tab.url}. Use computer-control-mac tools to interact with browser UI.` };
  }
