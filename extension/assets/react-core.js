      ...
      (s.exports = (function () {
        ...
        function r(t, r, n) {
          ...
          if (
            ...
            for (var o in ((n = {}), r)) "key" !== o && (n[o] = r[o]);
          else n = r;
          return (
            (r = n.ref),
            {
...
function h() {
  ...
  ((S.constructor = g), m(S, _.prototype), (S.isPureReactComponent = !0));
  var T = Array.isArray;
  function b() {}
  ...
  function D(r, n, a, o, s) {
    ...
    if (T(r))
      ...
      "function" ==
      typeof (y =
        null === (d = r) || "object" != typeof d
          ? null
          : "function" == typeof (d = (h && d[h]) || d["@@iterator"])
            ? d
            : null)
    )
      for (r = y.call(r), y = 0; !(o = r.next()).done; )
  ...
  return (
    ...
    (p.isValidElement = R),
    (p.lazy = function (e) {
      return { $$typeof: f, _payload: { _status: -1, _result: e }, _init: k };
    }),
    (p.memo = function (e, t) {
    ...
    (p.startTransition = function (e) {
      ...
      try {
        ...
        (null !== t && null !== r.types && (t.types = r.types), (A.T = t));
      }
    }),
...
function y() {
  return (l || ((l = 1), (d.exports = h())), d.exports);
}
var m = y();
const E = r(m),
  _ = e({ __proto__: null, default: E }, [m]);
function w(e) {
  let t,
    r,
    n,
  ...
  return function (o) {
    ...
    for (; r < s; ) {
      ...
      if (-1 === o) break;
      (e(t.subarray(i, o), n), (i = r), (n = -1));
    }
    i === s ? (t = void 0) : 0 !== i && ((t = t.subarray(i)), (r -= i));
  };
}
      ...
      try {
        ...
        (await T(r),
          await (async function (e, t) {
            ...
            w(
              (function (e, t, r) {
                let n = { data: "", event: "", id: "", retry: void 0 };
                const a = new TextDecoder();
                return function (o, s) {
                  if (0 === o.length)
                    (null == r || r(n),
                      (n = { data: "", event: "", id: "", retry: void 0 }));
                  else if (s > 0) {
                    const r = a.decode(o.subarray(0, s)),
                      i = s + (32 === o[s + 1] ? 2 : 1),
                      c = a.decode(o.subarray(i));
                    switch (r) {
                      case "data":
        ...
        if (!p.signal.aborted)
          try {
            const e =
              null !== (r = null == i ? void 0 : i(n)) && void 0 !== r ? r : y;
            (window.clearTimeout(m), (m = window.setTimeout(A, e)));
          } catch (a) {
            (E(), f(a));
          }
      }
...
function b(e) {
  ...
  if (!(null == t ? void 0 : t.startsWith(g)))
...
const A = {
  ...
  v = "fcoeoabgfenejglbffodgkkbkcdhcgfn",
  O = {
...
const L = (e) =>
  ...
  H = async (e, t) => {
    try {
      ...
      if (!r.ok) {
        ...
        return { success: !1, error: `Token refresh failed: ${r.status} ${e}` };
      }
      const n = await r.json();
      return n.error
        ? { success: !1, error: n.error_description || n.error }
        : {
            success: !0,
            accessToken: n.access_token,
            refreshToken: n.refresh_token || e,
            expiresAt: n.expires_in ? Date.now() + 1e3 * n.expires_in : void 0,
          };
    } catch (r) {
      return {
        success: !1,
  ...
  F = async () => {
    try {
      ...
      const t = Date.now(),
        r = e[I.TOKEN_EXPIRY],
        n = !!r && t < r;
      if (!(!!r && t >= r - 36e5)) return { isValid: n, isRefreshed: !1 };
      if (!e[I.REFRESH_TOKEN]) return { isValid: n, isRefreshed: !1 };
      const a = P();
      for (let o = 0; o < 3; o++) {
        const t = await H(e[I.REFRESH_TOKEN], a.oauth);
        if (t.success) return (await j(t), { isValid: !0, isRefreshed: !0 });
        if (2 === o)
          return (
            await k([I.ACCESS_TOKEN, I.REFRESH_TOKEN, I.TOKEN_EXPIRY]),
            { isValid: n, isRefreshed: !1 }
          );
      }
      return { isValid: n, isRefreshed: !1 };
    } catch {
      return { isValid: !1, isRefreshed: !1 };
    }
  },
  $ = async () => {
    if (!(await F()).isValid) return;
    return (await D(I.ACCESS_TOKEN)) || void 0;
  },
  V = async (e, t) => {
    try {
      ...
      if (!n) return { success: !1, error: "No authorization code received" };
      const i = (await D(I.CODE_VERIFIER)) || "",
        c = P(),
        u = await (async (e, t, r, n) => {
          try {
  ...
  G = async () => {
    const e = P(),
      ...
      r = L(crypto.getRandomValues(new Uint8Array(32))),
      n = await (async (e) => {
        const t = new TextEncoder().encode(e),
          r = await crypto.subtle.digest("SHA-256", t);
        return L(new Uint8Array(r));
      })(r);
    await U({ [I.OAUTH_STATE]: t, [I.CODE_VERIFIER]: r });
    const a = new URLSearchParams({
      ...
      o = `${e.oauth.AUTHORIZE_URL}?${a.toString()}`;
...
const Y = new (class {
  ...
  async fetch(e, t = {}) {
    const r = await $();
    if (!r) throw new Error("No valid OAuth token available");
  ...
  async fetchEventSource(e, t) {
    const r = await $();
    if (!r) throw new Error("No valid OAuth token available for SSE stream");
    const n = `${this.baseURL}${e}`,
...
class B {
  ...
  getFeatureValue(e, t) {
    ...
    return r && void 0 !== r.value && null !== r.value ? r.value : t;
  }
...
function X({ children: e }) {
  ...
  m.useEffect(() => {
    const e = (e) => {
      ...
      t =
        ((n = e),
        z || (z = new B({ fetchFeatures: W, onFeaturesUpdated: n })),
        z);
    var n;
    ((i.current = t),
      ...
      t
        ...
        .catch((e) => {
          (s(e instanceof Error ? e : new Error(String(e))), a(!0));
        }));
  }, []);
  const c = m.useCallback(
    ...
    u = m.useCallback((e) => !!i.current && i.current.isFeatureEnabled(e), [t]),
    l = m.useCallback(
      (e) => {
        if (i.current) return i.current.getFeature(e);
      },
      [t],
    ),
    d = m.useCallback((e) => void 0 !== t?.[e], [t]),
    p = m.useCallback(async () => {
      i.current && (await i.current.refresh());
    }, []),
    h = m.useMemo(
      () => ({
        isReady: n,
  ...
  return f.jsx(q.Provider, { value: h, children: e });
}
function J() {
...
function Q(e, t) {
  const { getFeatureValue: r } = J();
  return r(e, t);
}
function Z(e) {
  const { isFeatureEnabled: t } = J();
  return t(e);
}
function ee() {
  const { isReady: e } = J();
...
function le(e, t, r) {
  ...
  for (
    ...
    i = i[a] =
      o === s
        ? r
        : typeof (n = i[a]) == typeof t
          ? n
          : 0 * t[o] != 0 || ~("" + t[o]).indexOf(".")
            ? {}
            : [];
}
for (var fe, de = 256, pe = []; de--; )
...
function he() {
  var e,
    ...
    r = "";
  if (!fe || de + 16 > 256) {
    for (fe = Array((t = 256)); t--; ) fe[t] = (256 * Math.random()) | 0;
    t = de = 0;
  }
  for (; t < 16; t++)
    ((e = fe[de + t]),
      (r += 6 == t ? pe[(15 & e) | 64] : 8 == t ? pe[(63 & e) | 128] : pe[e]),
      1 & t && t > 1 && t < 11 && (r += "-"));
  return (de++, r);
}
class ye {
  ...
  static async updatePrompt(e, t) {
    ...
    const a = r[n];
    ((r[n] = { ...r[n], ...t }), await C(I.SAVED_PROMPTS, r));
    const o = r[n];
    return (
  ...
  static async exportPrompts(e) {
    const t = await this.getAllPrompts(),
      r = e ? t.filter((t) => e.includes(t.id)) : t;
    return JSON.stringify(r, null, 2);
  }
  static async importPrompts(e, t = !1) {
    const r = JSON.parse(e),
      n = t ? [] : await this.getAllPrompts(),
      a = r.map((e) => ({
        ...e,
      ...
      o = [...n, ...a].filter((e) => e.command).map((e) => e.command),
      s = new Set(o);
    if (o.length !== s.size)
      throw new Error("Import contains duplicate command shortcuts");
    const i = [...n, ...a];
    return (await C(I.SAVED_PROMPTS, i), a.length);
  }
  static async updateAlarmForPrompt(e) {
    ...
    if (
      ...
      return;
    const r = new Date(),
      [n, a] = e.specificTime.split(":").map(Number);
    switch (e.repeatType) {
      case "once": {
        if (!e.specificDate) return;
        const [o, s, i] = e.specificDate.split("-").map(Number),
          c = new Date(o, s - 1, i, n, a, 0, 0);
        c > r && (await chrome.alarms.create(t, { when: c.getTime() }));
        break;
      }
      case "daily": {
        const e = new Date();
        (e.setHours(n, a, 0, 0),
          e <= r && e.setDate(e.getDate() + 1),
      ...
      case "annually": {
        ...
        (i.setMonth(o - 1),
          i.setDate(s),
          i.setHours(n, a, 0, 0),
          i <= r && i.setFullYear(i.getFullYear() + 1),
  ...
  static async updateNextRunTimes() {
    ...
    let r = !1;
    for (const n of e)
      if (n.repeatType && "none" !== n.repeatType) {
        const e = t.find((e) => e.name === n.id),
          a = e?.scheduledTime;
        n.nextRun !== a && ((n.nextRun = a), (r = !0));
      } else n.nextRun && ((n.nextRun = void 0), (r = !0));
    r && (await C(I.SAVED_PROMPTS, e));
  }
}
const me = Object.freeze(
  Object.defineProperty(
    { __proto__: null, SavedPromptsService: ye },
    Symbol.toStringTag,
    { value: "Module" },
  ),
);
...
const _e = async () => {
    ...
    return (e || ((e = crypto.randomUUID()), await C(I.ANONYMOUS_ID, e)), e);
  },
  we = (e) => ({
...
var ge = ((e) => ((e.ALLOW = "allow"), (e.DENY = "deny"), e))(ge || {}),
  Se = ((e) => ((e.ONCE = "once"), (e.ALWAYS = "always"), e))(Se || {});
function Te(e) {
  return {
